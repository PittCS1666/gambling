...
impl Plugin for GamePlugin {
    fn build(&self, app: &mut App) {
        app.insert_resource(init_cards_resource())
            ...
            .add_systems(
                Update,
                check_button_interaction.run_if(in_state(AppState::LocalPlay)),
            )
            .add_systems(
                Update,
                raise_button_interaction.run_if(in_state(AppState::LocalPlay)),
            )
            .add_systems(
                Update,
                fold_button_interaction.run_if(in_state(AppState::LocalPlay)),
            )
            .add_systems(
                Update,
                call_button_interaction.run_if(in_state(AppState::LocalPlay)),
            )
            .add_systems(
                Update,
                handle_keyboard.run_if(in_state(AppState::LocalPlay)),
            )
            ...
            .add_systems(
                Update,
                save_buton_interaction.run_if(in_state(AppState::LocalPlay)),
            );
    }
}
