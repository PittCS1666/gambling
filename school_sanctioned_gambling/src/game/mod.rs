...
impl Plugin for GamePlugin {
    fn build(&self, app: &mut App) {
        ...
        .insert_resource(PokerTurn { current_player: 1, phase: PokerPhase::PreFlop, round_started: false, pot: 0, current_top_bet:0, small_blind: 0, big_blind: 1, small_blind_val: 25, big_blind_val: 50})
